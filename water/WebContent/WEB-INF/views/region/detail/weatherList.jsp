			...
			<div class="content fl">
				...
				<div class="content-view">
					<div class="box clearfix">	
						<h2 style="font-size: 25px">气象数据采集</h2><a href="${pageContext.request.contextPath}/ExportExportWeather?status=exportWeather"  style="font-size: 40px;margin-left: 650px"class="iconfont" >&#xe63f;</a>
						<table id="weatherTable" style="margin-top: 45px">
							<tr>
								...
								<td style="margin-top: 30px">风速（m/s）</td>
								
								<td style="margin-top: 30px">降雨量（mm）</td>
								
								<td style="margin-top: 30px">光照（klx）</td>
								<td style="margin-top: 30px">创建时间</td>
							</tr>
							<c:forEach items="${weatherPage.content}" var="weather">
								<tr>
...
$(function(){
	new GuangPage().init("${weatherPage.totalItems}",{$dom:$("#weatherPage"),callback:function(pageNo,pageSize){
