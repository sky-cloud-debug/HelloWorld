...
<%@include file="/WEB-INF/views/common/menu.jspf" %>
			...
			<div class="content fl">
				...
				<h2 style="font-size: 25px">修改区域信息</h2>
					<form  id="regionAddForm" style="margin-top: 45px" onsubmit="return false;">
						区域名&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="model.regionName" value="${model.regionName}"style="width: 30%"/><br></br>
						市级&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${model.city}"name="model.city" style="width: 30%"/><br></br>
						村镇&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" value="${model.town}"name="model.town" style="width: 30%"/><br></br>
						纬度（°）<input type="text" name="model.latitude" value="${model.latitude}"style="width: 30%"/><br></br>
						经度（°）<input type="text" name="model.longitude"  value="${model.longitude}"style="width: 30%"/><br></br>
						高程（°）<input type="text" name="model.altitude" value="${model.altitude}"style="width: 30%"/><br></br>
...
function regionAddFormSubmit(){
	$.ajax({
		url:"${pageContext.request.contextPath}/region/regionUpdate2",
		type:"POST",
