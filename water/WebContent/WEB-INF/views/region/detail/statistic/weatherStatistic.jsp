...
function initChart(charType,timeType,startTime,endTime){
	$.ajax({
		url:"${pageContext.request.contextPath}/region/detail/weatherStatisticData",
		data:{regionId:1,isDay:timeType,startTimeStr:startTime,endTimeStr:endTime},
		type:"post",
		dataType:"json",
	...
	function initCharts(json){
		...
		for(var i=0;i<json.length;i++){
			...
			rainHourArr.push(parseFloat(json[i].rainHour)*0.2);          
		...
		$("#highcharts_container").highcharts({ //图表展示容器，与div的id保持一致
			...
			series:[{"name":"空气温度",data:tempArr,tooltip: {
                ...
                valueSuffix: ' ppm'
            }},{"name":"累积降雨量",data:rainHourArr,tooltip: {
                valueSuffix: ' mm'
            }},
