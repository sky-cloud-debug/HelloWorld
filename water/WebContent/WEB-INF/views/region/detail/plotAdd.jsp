...
<%@include file="/WEB-INF/views/common/menu.jspf" %>
			...
			<div class="content fl">
				...
				<h2 style="font-size: 25px">添加站点信息</h2>
					<form  id="plotAddForm" style="margin-top: 45px " onsubmit="return false;">
						市&nbsp;&nbsp;名&nbsp;&nbsp;&nbsp;&nbsp;<select id="city" name="city" onchange="selectCity(this)"style="width: 30%">
							<option>请选择</option>
						</select><br></br>
						区域名&nbsp;&nbsp;&nbsp;&nbsp;<select id="region" name="region" style="width: 30%"onchange="selectRegion(this)">
							<option>请选择</option>
						</select><br></br>
						乡镇名&nbsp;&nbsp;&nbsp;&nbsp;<select id="county" name="model.county.id" style="width: 30%">
							<option>请选择</option>
						</select><br></br>
						站点名&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="model.plotName" style="width: 30%"/><br></br>
						站点连接ID号：&nbsp;<input type="text" name="model.plotId" style="width: 30%"/><br></br>
						<br></br>
						 <button  class="btn"style="margin-left:-5px  ; margin-top: 20px" onclick="plotAddFormSubmit()">保存</button>
					...
					$.ajax({
						...
						function plotAddFormSubmit() {
									$.ajax({
										url : "${pageContext.request.contextPath}/region/selectRegion/plotAdd",
										type : "POST",
										data : $("#plotAddForm").serialize(),
										dataType : "text",
										success : function(data) {
											if (data == "success") {
												alert("保存成功");
