...
<%@include file="/WEB-INF/views/common/common_css.jspf" %>
    ...
    <div class="single-content">
		<div class="single clearfix">
			...
			<div class="content fl"  >
				<div class="position">
					<a href="${pageContext.request.contextPath}/index.jsp">首页</a><i class="fa fa-angle-right"></i><a href="${pageContext.request.contextPath}/system.jsp">数据采集</a><i class="fa fa-angle-right"></i><span class="athere">乡镇情况</span>
				</div>
				<div class="content-view">
					<div class="box clearfix">
						<h2 style="font-size: 25px" >乡镇情况表</h2>
						<table id="areaTable" style="margin-top: 45px ;margin-left:-30px">
							<tr>
							    <td>乡镇名</td>
								<td>操作</td>
							</tr>
							<c:forEach items="${countyPage.content}" var="county">
								<tr id = "row_area">
									<td >${county.countyName}</td>
									
									<td>
									 <a href="javascript:;" onclick="ajaxDeleteCounty(${county.id},this)"><i class="iconfont" style="font-size:25px;">&#xe63c;</i></a></td>
								</tr>
							</c:forEach>
						</table>
				</div>
	...
	function ajaxDeleteCounty(id,obj){
	     $.ajax({
         url:"${pageContext.request.contextPath}/region/deleteCounty",
         type:"post",
         data:{countyId:id},
         dataType:"text",
