...
<%@include file="/WEB-INF/views/common/menu.jspf" %>
			...
			<div class="content fl">
				<div class="position">
					<a href="${pageContext.request.contextPath}/index.jsp">首页</a><i class="fa fa-angle-right"></i><a href="#">区域管理</a><i class="fa fa-angle-right"></i><span class="athere">添加市信息</span>
				</div>
				<div class="content-view">
				<h2 style="font-size: 25px">添加市信息</h2>
					<form  id="cityAddForm" style="margin-top: 45px " onsubmit="return false;">
						市名&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="model.cityName" style="width: 30%"/><br></br>
						 <button  class="btn"style="margin-left:-5px  ; margin-top: 20px" onclick="cityAddFormSubmit()">保存</button>
                       <button type="reset" class="btn"style=" margin-left: 20px ;margin-top: 20px">重置</button>					
					</form>
					<script type="text/javascript">
function cityAddFormSubmit(){
	$.ajax({
		url:"${pageContext.request.contextPath}/region/selectRegion/cityAdd",
		type:"POST",
