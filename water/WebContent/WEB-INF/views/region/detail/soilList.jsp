			...
			<div class="content fl">
				...
				<div class="content-view">
					<div class="box clearfix">
						<h2 style="font-size: 25px">土壤墒情采集信息</h2><a href="${pageContext.request.contextPath}/ExportExportSoil?status=exportSoil"  style="font-size: 40px;margin-left: 650px"class="iconfont" >&#xe63f;</a>
						...
						<table id="soilTable" style="margin-top: 45px">
							...
							<c:forEach items="${soilPage.content}" var="soil">
								<tr>
...
function loadData(pageNo,pageSize,type){
	$.ajax({
		...
		type:"post",
		data:{pageNo:pageNo,pageSize:pageSize,plotIdName:getCookie("plotName")},
		dataType:"text",
		success:function(data){
