...
<%@include file="/WEB-INF/views/common/menu.jspf" %>
			...
			<div class="content fl">
				...
				<h2 style="font-size: 25px">人工录入作物采集信息</h2><a href="${pageContext.request.contextPath}/region/detail/updateCrop"  style="font-size: 30px; margin-left: 260px"class="iconfont" >&#xe63e;</a>
					<form  id="regionAddForm" style="margin-top: 45px" onsubmit="return false;">
						田地号&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"value="${ areaId}" name="areaId" style="width: 30%"/><br></br>
						冠层温度&nbsp;&nbsp;<input type="text" name="modle.canopyTemperature"value="${modle.canopyTemperature}" style="width: 30%"/><br></br>
						品质&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="modle.quality" value="${modle.quality}"style="width: 30%"/><br></br>
						生理生化指标&nbsp;&nbsp;<input type="text" name="modle.physiologicalAndBiochemicalIndexes" value="${modle.physiologicalAndBiochemicalIndexes}"style="width: 30%"/><br></br>
