...
<%@include file="/WEB-INF/views/common/menu.jspf" %>
			...
			<div class="content fl">
				...
				<h2 style="font-size: 25px">添加田地信息</h2>
					<form  style="margin-top: 45px"  method="post" id="areaAddForm" onsubmit="return false;">
					           区域号&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="regionId"style="width: 30%"/><br></br>
						田地名字&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="model.areaName"style="width: 30%"/><br></br>
						灌水上限(%)&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="model.irrigationUpperLimit"style="width: 30%"/><br></br>
						灌水下限(%)&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="model.irrigationLowerLimit"style="width: 30%"/><br></br>
						田间持水率(%)&nbsp;<input type="text" name="model.waterholdingCapacity"style="width: 30%"/><br></br>
						生育初期土壤计划湿润层深度(cm)<input type="text" name="model.firstStageDepthOfWetting"style="width: 30%"/><br></br>
						生育中期土壤计划湿润层深度(cm)<input type="text" name="model.secondStageDepthOfWetting"style="width: 30%"/><br></br>
						生育后期土壤计划湿润层深度(cm)<input type="text" name="model.thirdStageDepthOfWetting"style="width: 30%"/><br></br>
						生育初期作物系数&nbsp;&nbsp;&nbsp;<input type="text" name="model.firstCropCoefficient"style="width: 30%"/><br></br>
						生育中期作物系数&nbsp;&nbsp;&nbsp;<input type="text" name="model.secondCropCoefficient"style="width: 30%"/><br></br>
						生育后期作物系数&nbsp;&nbsp;&nbsp;<input type="text" name="model.thirdCropCoefficient"style="width: 30%"/><br></br>
						土壤类型&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="model.soilType"style="width: 30%"/><br></br>
						土壤干容重(g/cm3)&nbsp;<input type="text" name="model.soilDryBulkDensity"style="width: 30%"/><br></br>
						出水口号码&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="model.outletNumber"style="width: 30%"/><br></br>
						灌溉面积（亩）&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="model.irrigationArea"style="width: 30%"/><br></br>
