...
<%@include file="/WEB-INF/views/common/menu.jspf" %>
			...
			<div class="content fl">
				<div class="position">
					<a href="${pageContext.request.contextPath}/index.jsp">首页</a><i class="fa fa-angle-right"></i><a href="#">决策服务</a><i class="fa fa-angle-right"></i><span class="athere">短信发送历史记录</span>
				</div>
				<div class="content-view">
					<div class="box clearfix" >
						<h2 style="font-size: 25px">短信发送历史记录</h2>
